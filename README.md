# React Rails App<a name="readme-top"></a>
...
**Budget App** Implement a connection between a Ruby on Rails back-end and React front-end using webpack.
...
```bash
git clone https://github.com/ezraermy/react-rails-app.git
```
